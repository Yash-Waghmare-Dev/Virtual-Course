      ...
      <div className="w-[100%] h-[70px] fixed top-0 px-[20px] py-[10px] flex items-center justify-between bg-[#00000047] z-10">
        ...
        <div className="w-[30%] lg:flex items-center justify-center gap-4 hidden">
          ...
          {userData?.role === "educator" && (
            <div className="px-[20px] py-[10px] border-2 lg:border-white border-black lg:text-white bg-[black] rounded-[10px] text-[18px] font-light cursor-pointer" onClick={()=>navigate('/dashboard')}>
              DashBorad
            </div>
          )}
          {!userData ? (
        ...
        >
          ...
          />
          {!userData && 
            <IoPersonCircleOutline className="w-[50px] h-[50px] fill-black cursor-pointer" />
          }
          ...
          <div className="w-[200px] h-[65px] border-2 lg:border-white border-black lg:text-white bg-[black] flex items-center justify-center rounded-[10px] text-[18px] text-white cursor-pointer" onClick={()=>navigate('/profile')}>
            My Profile
          </div>
          <div className="w-[200px] h-[65px] border-2 lg:border-white border-black lg:text-white bg-[black] flex items-center justify-center rounded-[10px] text-[18px] text-white cursor-pointer" onClick={()=>navigate('/mycourses')}>
            My Courses
          </div>
          {userData?.role === "educator" && (
            <div className="w-[200px] h-[65px] border-2 lg:border-white border-black lg:text-white bg-[black] flex items-center justify-center rounded-[10px] text-[18px] text-white cursor-pointer" onClick={()=>navigate('/dashboard')}>
              DashBorad
            </div>
          )}
          {!userData ? (
            <span
              onClick={() => navigate("/login")}
              className="w-[200px] h-[65px] border-2 lg:border-white border-black lg:text-white bg-[black] flex items-center justify-center rounded-[10px] text-[18px] text-white cursor-pointer"
            >
              Login
            </span>
          ) : (
