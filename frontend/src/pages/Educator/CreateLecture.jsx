  ...
  return (
    <div className='min-h-screen bg-gray-100 flex items-center justify-center p-4'>
        <div className='bg-white shadow-xl rounded-xl w-full max-w-2xl p-6'>
            {/* Header  */}
            <div className='mb-6'>
                <h1 className='text-2xl font-semibold text-gray-800 mb-1'>Create Lecture</h1>
                <p className='text-sm text-gray-500'>Enter the title and add your video lectures to enhnace your course content.</p>
            </div>

            {/* Input Area  */}
            <input type="text" className='w-full border-gray-300  rounded-md p-3 text-sm focus:outline-none focus:ring-2 focus:ring-black mb-4' placeholder='e.g, Intoduction to Full Stack' onChange={(e)=>setLectureTitle(e.target.value)} value={lectureTitle}/>
