        ...
        <form className='w-[90%] md:w-200 h-150 bg-[white] shadow-xl rounded-2xl flex'>
                 ...
                 <div className='md:w-[50%] w-[100%] flex flex-col items-center justify-center gap-3'>
                    ...
                    <div className='flex flex-col gap-1 w-[80%] items-start justify-center px-3 relative'>
                        ...
                        {!show ? <LuEyeClosed className='absolute w-[20px] h-[20px] cursor-pointer right-[5%] bottom-[10%]' onClick={()=>setShow(prev => !prev)}/> :
                        <LuEye className='absolute w-[20px] h-[20px] cursor-pointer right-[5%] bottom-[10%]' onClick={()=>setShow(prev => !prev)}/>}
                    </div>
                    <div className='flex md:w-[50%] w-[70%] items-center justify-between'>
                        <span className='px-[10px] py-[5px] border-[2px] border-[#e7e6e6] rounded-2xl cursor-pointer hover:border-black'>Students</span>
                    ...
                    <div className='text-[#6f6f6f]'>
                        already have an accout? <span onClick={()=>navigate('/login')} className='underline-offset-1 text-[black] cursor-pointer'>Login</span>
                    </div>
                 </div>
